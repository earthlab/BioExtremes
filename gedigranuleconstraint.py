...
class GEDIGranuleConstraint:
    ...
    def getboundingpolygon(cls, url) -> np.ndarray:
        ...
        :return: The bounding polygon of the granule listed by the xml file, as an ordered list of (lon, lat) vertices.
        """
    ...
    def __init__(self, spatial_predicate=lambda x: True):
